                    ...
                    <table className="w-full border-collapse">
                        ...
                        <tbody>
                            {roomList.map((room, index) => {
                                ...
                                return (
                                    <tr key={`room-${room.roomId || index}`} className="border-b border-gray-200 hover:bg-gray-50">
                                        <td className="px-4 py-4 border border-gray-200">
                                            <div className="flex items-start gap-2">
                                                <MdBed className="w-6 h-6 text-gray-600 shrink-0 mt-0.5" />
                                                <div>
                                                    <p className="text-gray-500">{room.main_room_type || room.main_name || room.room_name}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-4 py-4 border border-gray-200">
                                        ...
                                        <td className="px-4 py-4 border border-gray-200 text-center">
                                            <button className="bg-yellow-300 hover:bg-yellow-400 text-gray-900 font-light text-sm px-6 py-2 rounded transition duration-200 shadow-sm hover:shadow-md">
                                                Choose
                                            </button>
                                        </td>
                                    </tr>
